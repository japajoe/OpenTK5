...
namespace OpenTK.Audio
{
    public static unsafe class ALLoader
    {
        ...
        private static extern IntPtr alcGetProcAddress(ALCDevice device, byte* name);
        
        [DllImport("openal", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr alGetProcAddress(byte* name);
        ...
        public static IntPtr ALCGetProcAddress(string procName)
        {
